...
<H4>Scope(영역)</H4>
<pre>
   :웹 어플리케이션에서 데이터를 공유할 때 사용할 수있는 메모리.
   ...
   3. session Scope (session) : 한 세션내에서 관리되는 영역. <!-- 로그인을 했을 때의 영역, 로그인 한 당사자만 그 페이지를 볼 수 있어야 한다. -->
   4. application Scope (application) : 웹 어플리케이션에서 전역 데이터 관리 영역. <!-- 모든사람들이 볼 수 있는 영역 -->
   <%
