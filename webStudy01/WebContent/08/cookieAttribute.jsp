...
<pre>
	...
	<%
		...
		String otherPathCookieValue =URLEncoder.encode("09의 하위경로에서 사용할 쿠키","UTF-8");
...
// 		otherDomainCookie.setDomain(".csh2.com");
